;(function(window,document,$,undefined){
    var t=0;
        ...
        function initFn(){
            ...
            $('#section8 .title-01').stop().animate({left:550+1000,opacity:0},2000, function(){
                $('#section8 .title-01').stop().animate({left:550+0,opacity:1},2500);
            });
            $('#section8 .title-02').stop().animate({left:523+1000,opacity:0},2000, function(){
        ...
        function formatFn(){
            ...
            $('#section8 .title-01').stop().animate({left:550+1000,opacity:0},2000);
            $('#section8 .title-02').stop().animate({left:523+1000,opacity:0},2000);
        }
